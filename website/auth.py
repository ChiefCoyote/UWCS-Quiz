...
def login():
    ...
    #Username: admin
    #Password: admin123
    #user = User(username = "admin", email = "admin@gmail.com", passwordHash = "scrypt:32768:8:1$1ZdBRTg0ElnnpsYG$1c486ce80ec02edca8aa0843828caff9267f3ccd40c5be785da32f2c79345b46f287993b39be8542d23b2164f4e0b47a8a88334cc16cde4bc9786a3c23a293dc", isVerified = True)
    #db.session.add(user)
    #db.session.commit()
